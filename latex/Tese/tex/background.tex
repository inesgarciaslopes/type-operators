...
\todo{expressiveness of system f: define a small syntax and then the computational model.}\\
\todo{expressiveness of system fmu: define a small syntax and then the computational model.}\\
\todo{system fmu; define small syntax.}\\
...
Almeida's algorithm is an essential part of checking if two types are equivalence in FreeST. 
...
\todo{figure: systems and their equivalence computational models.}
