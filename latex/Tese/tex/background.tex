...
%If we go back to System $F$, two types are considered equivalent if they can be rewritten into the same form using alpha-equivalence (renaming of bound variables) and beta-reduction (applying type abstractions).
