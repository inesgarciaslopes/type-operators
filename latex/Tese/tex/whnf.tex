...
\begin{figure}[!t]
  ...
  \and
  \inferrule*[lab=w-dual]{\iswhnf{T_1} \\ \typec{T_1} \neq \quant\kind, \Skip, \Wait, \Close, \Sharp\typec{U},\seqcomp{U}{V}, \typec{\odot}{\trecord{l_i}{U_i}}, \tappdual{(\tapp{\talpha}{U_1...U_m})} \\ \mathtt\mathit m \geq 0}{\iswhnf{\tapp{\Dual}{T_1...T_m}}}
	\end{mathpar}
