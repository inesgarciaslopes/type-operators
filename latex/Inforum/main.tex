...
We follow Poças et al. \cite{PocasCMV23} type equivalence approach, based on type bisimulation, and ensure decidability by reducing the problem to the bisimilarity of simple grammars.
